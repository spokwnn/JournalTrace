...
Multi-Column Filters: Dynamically parse FilterOption:Filter syntax to target specific columns, use ; between Filter Option and Filter option, FilterOption1:Filter1;FilterOption2:Filter2.
Example Usage
...
StCroixSkippers
StCroixSkippers wrote the wrapper of the UsnJournal Win32 API to C#. Without this wrapper the project wouldn't even see the light of day.
